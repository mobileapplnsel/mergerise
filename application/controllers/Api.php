                            ...
                            if (!empty($getBoughtCrypto)) {
                                ...
                                foreach ($getBoughtCrypto as $key => $value) {
                                    ...
                                    //      </tr>
                                     ...
                                     $filename = 'Crypto_BuyInv_'.$key.'_'.date("YmdHis", time()) .'.pdf';
                                     $filepath = base_url().'uploads/invoices/'.$filename;
                            ...
                            if (!empty($getSoldCrypto)) {
                                ...
                                foreach ($getSoldCrypto as $key => $value) {
                                    ...
                                    //  $project_amount = $value->project_amount;
                                     ...
                                     $filename = 'Crypto_SellInv_'.$key.'_'.date("YmdHis", time()) .'.pdf';
                                     $filepath = base_url().'uploads/invoices/'.$filename;
                        ...
                        if ($if_not_blank == 1) {
                            ...
                            if (!empty($userDetails)) {
                                if(is_numeric($amount)){
                                    ...
                                    $return['respData'] = [];
                                    $return['success'] = 0;
                                    $return['message'] = 'Wallet amount is not valid!';
                                }

                            } else {
                                $return['respData'] = [];
                                $return['success'] = 0;
                                $return['message'] = 'User Not found! Withdrawal request failure!';
                            }
