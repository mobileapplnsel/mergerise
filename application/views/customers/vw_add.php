					...
					<div class="col-12">
						<div class="card">
							...
							<form class="form-horizontal" id="create_customer_form" autocomplete="off">
								<div class="card-body">
									<h4 class="card-title">Create New <?php echo $page_title; ?> <button type="button" class="btn badge badge-pill badge-success" onclick="location.href='<?php echo base_url() . 'customers/list'; ?>'"><?php echo $page_title; ?>s List</button></h4>
